...
export function SteamLanding() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Да, сервис берет небольшую комиссию для поддержания работы. Точную сумму к оплате вы увидите перед подтверждением платежа.",
    },
  ];
    ...
    <div className="flex flex-col w-full">
      ...
      <div className="relative">
        ...
        <section className="relative z-10 mx-auto max-w-6xl flex flex-col gap-12 px-4 py-16 sm:px-6 lg:px-8 lg:py-24 text-center items-center">
          ...
          >
            Моментальное зачисление средств на ваш кошелек Steam. Минимальная
            комиссия. Вход только по логину.
          </motion.p>
